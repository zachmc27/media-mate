...
export default function FeaturedCard() {
  ...
  return (
    <div className="featured-box">
      ...
      <div className="info">
        <h2 className="title-md-light work-sans">{mediaItem?.title}</h2>
        <p className="p-light poppins">{mediaItem?.year}</p>
        <p className="p-light poppins">{mediaItem?.overview}</p>
        <p className="p-light poppins">{mediaItem?.cast}</p>
      </div>
    </div>
  )
}
